...
var process_data = function(accidents_csv_path, remarks_csv_path, file_path){
  fs.readFile(remarks_csv_path, 'utf-8', function(err, remarks){
    ...
    fs.readFile(accidents_csv_path, 'utf-8', function(err, data){
      if(err) throw err;
      data = CSVToArray(data);
      data[0].filter(function(d, i){
        i = i.toString();
        //  Accident Categories
        switch(d)
        {
      ...
      data.map(function(row, i){
        ...
        if(i > 0 && row[2] == 91){
            ...
            for(var key in accidents_categories){
              switch(accidents_categories[key]){
                ...
                case 'primary_cause':
                  ...
                  break;
                case 'flight_phase':
                  row[key] = accident_codes.flight_phase[row[key]];
                  break;
                case 'light':
              ...
              data_object.accident_data[accidents_categories[key]] = row[key];
            }
            data_object.pilot_data = {};
            for(var key in pilots_categories){
              ...
              if(typeof(row[key]) == 'undefined' || row[key] == ''){row[key] = null;}
              data_object.pilot_data[pilots_categories[key]] = row[key];
            }
            data_object.aircraft_data = {};
            for(var key in aircrafts_categories){
              switch(aircrafts_categories[key]){
                case 'weight_class':
                  row[key] = aircraft_codes.weight_class[row[key]];
                  break;
                case 'wing_information':
                  row[key] = aircraft_codes.wing_information[row[key]];
                  break;
                case 'aircraft_design':
                case 'aircraft_make':
                case 'aircraft_model':
                case 'aircraft_group':
                  row[key] = row[key].replace(/\s{1,}/, '');
                  break;
                default:
                  break;
              }
              if(!isNaN(parseInt(row[key]))){row[key] = parseInt(row[key])};
              if(typeof(row[key]) == 'undefined' || row[key] == ''){row[key] = null;}
              data_object.aircraft_data[aircrafts_categories[key]] = row[key];
            }
            data_object.remarks = remarks_dict[row[0]];
            clean_data.push(data_object);
          }
      });
      fs.writeFile(file_path, JSON.stringify(clean_data), function (err) {
        if (err) throw err;
...
var accident_remarks_dict = {
  1975 : { accidents_csv_path : '../../data/accidents/a1975_79.csv', remarks_csv_path : '../../data/remarks/e1975_79.csv', file_path : '../../data/91_json/data_1975_79.json'},
  1980 : { accidents_csv_path : '../../data/accidents/a1980_84.csv', remarks_csv_path : '../../data/remarks/e1980_84.csv', file_path : '../../data/91_json/data_1980_84.json'},
  1985 : { accidents_csv_path : '../../data/accidents/a1985_89.csv', remarks_csv_path : '../../data/remarks/e1985_89.csv', file_path : '../../data/91_json/data_1985_89.json'},
  1990 : { accidents_csv_path : '../../data/accidents/a1990_94.csv', remarks_csv_path : '../../data/remarks/e1990_94.csv', file_path : '../../data/91_json/data_1990_94.json'},
  1995 : { accidents_csv_path : '../../data/accidents/a1995_99.csv', remarks_csv_path : '../../data/remarks/e1995_99.csv', file_path : '../../data/91_json/data_1995_99.json'},
  2000 : { accidents_csv_path : '../../data/accidents/a2000_04.csv', remarks_csv_path : '../../data/remarks/e2000_04.csv', file_path : '../../data/91_json/data_2000_04.json'},
  2005 : { accidents_csv_path : '../../data/accidents/a2005_09.csv', remarks_csv_path : '../../data/remarks/e2005_09.csv', file_path : '../../data/91_json/data_2005_09.json'},
  2010 : { accidents_csv_path : '../../data/accidents/a2010_14.csv', remarks_csv_path : '../../data/remarks/e2010_14.csv', file_path : '../../data/91_json/data_2010_14.json'}
};
...
process_data(accident_remarks_dict['1975'].accidents_csv_path, accident_remarks_dict['1975'].remarks_csv_path, accident_remarks_dict['1975'].file_path);
process_data(accident_remarks_dict['1980'].accidents_csv_path, accident_remarks_dict['1980'].remarks_csv_path, accident_remarks_dict['1980'].file_path);
process_data(accident_remarks_dict['1985'].accidents_csv_path, accident_remarks_dict['1985'].remarks_csv_path, accident_remarks_dict['1985'].file_path);
process_data(accident_remarks_dict['1990'].accidents_csv_path, accident_remarks_dict['1990'].remarks_csv_path, accident_remarks_dict['1990'].file_path);
process_data(accident_remarks_dict['1995'].accidents_csv_path, accident_remarks_dict['1995'].remarks_csv_path, accident_remarks_dict['1995'].file_path);
process_data(accident_remarks_dict['2000'].accidents_csv_path, accident_remarks_dict['2000'].remarks_csv_path, accident_remarks_dict['2000'].file_path);
process_data(accident_remarks_dict['2005'].accidents_csv_path, accident_remarks_dict['2005'].remarks_csv_path, accident_remarks_dict['2005'].file_path);
process_data(accident_remarks_dict['2010'].accidents_csv_path, accident_remarks_dict['2010'].remarks_csv_path, accident_remarks_dict['2010'].file_path);

//  Asynchronous Data Processing
// async.parallel([function(callback){
//   process_data(accident_remarks_dict['1975'].accidents_csv_path, accident_remarks_dict['1975'].remarks_csv_path, accident_remarks_dict['1975'].file_path);
//   return callback('1975');
// }, 
// function(callback){
//   process_data(accident_remarks_dict['1980'].accidents_csv_path, accident_remarks_dict['1980'].remarks_csv_path, accident_remarks_dict['1980'].file_path);
//   return callback('1980');
// },
// function(callback){
//   process_data(accident_remarks_dict['1985'].accidents_csv_path, accident_remarks_dict['1985'].remarks_csv_path, accident_remarks_dict['1985'].file_path);
//   return callback('1985');
// },
// function(callback){
//   process_data(accident_remarks_dict['1990'].accidents_csv_path, accident_remarks_dict['1990'].remarks_csv_path, accident_remarks_dict['1990'].file_path);
//   return callback('1990');
// },
// function(callback){
//   process_data(accident_remarks_dict['1995'].accidents_csv_path, accident_remarks_dict['1995'].remarks_csv_path, accident_remarks_dict['1995'].file_path);
//   return callback('1995');
// },
// function(callback){
//   process_data(accident_remarks_dict['2000'].accidents_csv_path, accident_remarks_dict['2000'].remarks_csv_path, accident_remarks_dict['2000'].file_path);
...
// function(callback){
//   process_data(accident_remarks_dict['2005'].accidents_csv_path, accident_remarks_dict['2005'].remarks_csv_path, accident_remarks_dict['2005'].file_path);
//   return callback('2005');
// },
// function(callback){
//   process_data(accident_remarks_dict['2010'].accidents_csv_path, accident_remarks_dict['2010'].remarks_csv_path, accident_remarks_dict['2010'].file_path);
//   return callback('2010');
